...
(function() {
  ...
  $.localize = function(pkg, options) {
    ...
    jsonCall = function(file, pkg, lang, level) {
      ...
      return $.ajax(ajaxOptions).fail(function (){ if(options.failCallback != null) options.failCallback(); }); //xat -added the fail callback
    };
    ...
    localizeElement = function(elem, key, value) {
      if(value!=null) //xat added - dont blank out objects if we dont have a value for them
      {
      elem.show(); //xat added - show it when its set
      if (elem.is('input')) {
